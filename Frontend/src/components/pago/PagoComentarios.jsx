...
const ComentariosPago = () =>{
  ...
  useEffect(() => {
    ...
    const obtenerTurnos = () => {
      socket.emit('getUsuarioPagosComentado');
    };
    ...
    socket.on('respuestaResponderTurnoPago', (turnos) => {
      setTurnos(turnos);
    });
    ...
    return () => {
      ...
      socket.off('respuestaResponderTurnoPago');
    };
  }, []);

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Atender de Pagos</h1>
...
export default ComentariosPago